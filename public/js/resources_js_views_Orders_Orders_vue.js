  ...
  methods: {
    getOrderStatus: function getOrderStatus(tabTitle) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/order_statuses').then(function (response) {
        ...
        _this.statuses = response.data.data.filter(function (status) {
                  ...
                  _c(
                    "b-tab",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          _vm.getOrders
                          _vm.getOrderStatus("Order Items")
                        },
                      },
                    },
                    [
                                ...
                                fn: function (row) {
                                  return [
                                    row.item.active_status == "2"
                                      ...
                                      : row.item.active_status == "7"
                                      ? _c(
                                          "span",
                                          { staticClass: "badge bg-danger" },
                                          [_vm._v("Returned")]
                                        )
                                      : row.item.active_status == "8"
                                      ? _c(
                                          "span",
                                          { staticClass: "badge bg-danger" },
                                          [_vm._v("Cancelled")]

...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
        ...
        data: function data() {
          return {
            ...
            description: '',
            is_approved: this.require_products_approval === 0 ? 1 : 0,
            loose_stock: 0,
            loose_stock_unit_id: "",
            status: 1,
          ...
          getSellerCategories: function getSellerCategories() {
            ...
            if (this.seller_id !== 0 && this.seller_id !== "") {
              ...
              axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/categories/seller_categories', {
                ...
                _this2.categoryOptions = "<option value=\"\">--Select Category--</option>" + data;
          ...
          getSeller: function getSeller() {
            ...
            if (this.seller_id !== 0 && this.seller_id !== "") {
              ...
              axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/sellers/edit/' + this.seller_id, {
                ...
                _this3.isLoading = false, _this3.require_products_approval = response.data.data.require_products_approval;
                _this3.is_approved = _this3.require_products_approval === 0 ? 1 : 0;
                // console.log(this.require_products_approval + 'require_products_approval');
                //console.log(this.is_approved + 'is_approved');
              });
            }
          },
          ...
          getProduct: function getProduct() {
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/edit/' + this.id).then(function (response) {
              ...
              if (data.status === 1) {
                ...
                _this11.seller_id = _this11.record.seller_id;
                _this11.getSellerCategories();
                _this11.getSeller();
                if (_this11.record.tags) {
                  _this11.tags = _this11.record.tags.split(",");
                }
                _this11.tax_id = _this11.record.tax_id;
                ...
                _this11.fssai_lic_no = _this11.record.fssai_lic_no;
                var vm = _this11;
                              ...
                              ? _c(
                                ...
                                [
                                  _c("div", { staticClass: "row" }, [
                                    ...
                                    _vm._v(" "),
                                    _c("div", { staticClass: "col-md-12 hidden" }, [
                                      _c("div", { staticClass: "form-group" }, [
                                        _c("label", [

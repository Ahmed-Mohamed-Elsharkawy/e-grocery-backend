                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">New Registered Delivery Boys</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">New Registered Delivery Boys</h4>
    ...
    data: function() {
        return {
            fields: [
                ...
                { key: 'admin.email', label: 'Email', sortable: true,  class: 'text-center' },
                { key: 'bonus_percentage', label: 'Bonus(%)', sortable: true, class: 'text-center' },
                { key: 'documents', label: 'Documents', sortable: true, class: 'text-center' },
                { key: 'dob', label: 'Date of Birth', sortable: true,  class: 'text-center' },
                { key: 'city.formatted_address', sortable: true, label: 'City',  class: 'text-center' },

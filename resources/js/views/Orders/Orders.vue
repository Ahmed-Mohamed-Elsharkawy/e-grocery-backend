                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <b-tabs pills active-nav-item-class="font-weight-bold text-uppercase">
                            ...
                            <b-tab title="Orders" active @click="getOrders; getOrderStatus('Orders')">
<!--                                <b-row class="mb-2">
...
<!--                                <b-row>
                            ...
                            <b-tab title="Order Items" @click="getOrders; getOrderStatus('Order Items')">
                                <div class="table-responsive mt-3">
                                    <b-table
                                        :items="order_items"
...
<!--                                        <template #head(total)="row">
                                        ...
                                        <template #cell(active_status)="row">
                                            <span v-if="row.item.active_status == '2'" class="badge bg-primary">Received</span>
                                            <span v-else-if="row.item.active_status == '1'" class="badge bg-secondary">Payment Pending</span>
                                            <span v-else-if="row.item.active_status == '4'" class="badge bg-info">Processed</span>
                                            <span v-else-if="row.item.active_status == '5'" class="badge bg-warning">Shipped</span>
                                            <span v-else-if="row.item.active_status == '6'" class="badge bg-success">Delivered</span>
                                            <span v-else-if="row.item.active_status == '7'" class="badge bg-danger">Returned</span>
                                            <span v-else-if="row.item.active_status == '8'" class="badge bg-danger">Cancelled</span>
        ...
        getOrders(){
            ...
            axios.get(this.$apiUrl + '/orders',{ 
                params: param
                    ...
                    this.totalOrderItemRows = this.order_items.length;
                    this.order_items_total_sum = this.order_items.map(item => Number(item.total)).reduce((prev, curr) => prev + curr, 0).toFixed(2);

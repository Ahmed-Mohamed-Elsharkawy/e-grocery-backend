<template>
   ...
   <!-- <a v-for="(image, index) in row.item.images" :key="index" :href="image.image_url"  data-toggle="lightbox" data-gallery="gallery-1">
      <img class="images_border" :src="image.image_url" alt="Image" height="50">
    </a> -->
 
    
    <a v-for="(image, index) in row.item.images" :key="index" @click="openLightbox(image.image_url)">
      <img class="images_border" :src="image.image_url" alt="Image" height="50">
    </a>
...
export default {
  ...
  console.log('lightboxSources:', this.lightboxSource);

<template>
    ...
    <div id="status" class="btn-group">
        ...
        <label class="btn btn-success" data-toggle-class="btn-success" data-toggle-passive-class="btn-default">
            <input type="radio" v-model="returnRequest.status" value="2" class="form-check-input"> Approved
        </label>
        <label class="btn btn-danger" data-toggle-class="btn-danger" data-toggle-passive-class="btn-default">
            <input type="radio" v-model="returnRequest.status" value="3" class="form-check-input"> Cancelled
        </label>
    </div>
</div>
...
<div class="form-group" v-if="returnRequest.status == 2">
    ...
    <form class="row g-3 align-items-center" ref="my-form">
        <div class="input-group">
            ...
            <!-- Additional form controls or buttons can be added here -->
        </div>
    </form>
</div>
                                    </div>

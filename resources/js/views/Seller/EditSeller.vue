                        ...
                        <div class="card" v-if="this.$roleSeller !== this.login_user.role.name" >
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <div class="form-group">
                                            <label class="control-label"> {{__('view_order_otp')}}</label><br>
                                            <b-form-radio-group
                                    ...
                                    <div class="form-group col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">{{__('can_assign_delivery_boy')}}</label><br>
                                            <b-form-radio-group
                                    ...
                                    <div class="form-group col-md-3">
                                        <div class="form-group">
                                            <label class="control-label"> {{__('can_chnage_order_status_to_delivered')}}</label><br>
                                            <b-form-radio-group
            ...
            <b-container fluid>
                <ol>
                    ...
                    <li>
                        ...
                        11-Aug seller commission will get credited when admin is logged in admin panel.
                    </li>
                    <li>
                        Ex - 2. Order placed on 11-Aug-21 and product return days are set to 7 so 11-Aug + 7 days =
                        18-Aug seller commission will get credited when admin is logged in admin panel.
                    </li>

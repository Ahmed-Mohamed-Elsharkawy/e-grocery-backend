                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="pull-right" v-if="login_user.role.name === 'Super Admin' || login_user.role.name === 'Admin'">
                            <button class="btn btn-primary" @click="create_new=true">Add Transactions {{ __('add_transactions') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        <b-row class="mb-2">
                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(type)="row">
                                    <span v-if="row.item.type === 'credit'" class="badge bg-success">Credit {{ __('credit') }}</span>
                                    <span v-else class="badge bg-danger">Debit {{ __('debit') }}</span>
                                </template>

                                <template #cell(status)="row">
                                    <span v-if="row.item.status === 1" class="badge bg-success">Active {{ __('active') }}</span>
                                    <span v-else class="badge bg-danger">Deactive {{ __('deactive') }}</span>
                                </template>

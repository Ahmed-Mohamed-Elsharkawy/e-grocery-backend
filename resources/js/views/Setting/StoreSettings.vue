                                            ...
                                            <form method="post" enctype="multipart/form-data" @submit.prevent="saveRecord">
                                                <div class="row">
                                                    ...
                                                    <div class="list-group-item d-none">
                                                        <div class="row">
                                                            <div class="form-group col-md-4">
                                                                <label for="is_version_system_on">{{ __('version_system_status') }}</label><br>
                                                            ...
                                                            <div class="form-group col-md-4" v-if="store_settings.is_version_system_on == 1">
                                                                <label for="required_force_update">{{ __('required_force_update') }}</label><br>
                                                                <div class="form-check form-switch">
                                                            ...
                                                            <div class="form-group col-md-4" v-if="store_settings.is_version_system_on == 1">
                                                                <label for="current_version">{{ __('current_version_of_app') }}</label>
                                                    ...
                                                    <div class="list-group-item mb-3 d-none">
                                                        <div class="row">
                                                            <div class="form-group col-md-4">
...
<form method="post" enctype="multipart/form-data" @submit.prevent="saveRecord">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="max_cart_items_count"> {{ __('maximum_items_allowed_in_cart') }}</label>
                             ...
                             <div class="row">
                                <div class="form-group col-md-4">
                                    <b-button type="submit" variant="primary" :disabled="isLoading" v-if="$can('manage_store_settings')">{{ __('update') }}
                                        ...
                                        <div v-if="activeTab === __('maitenance_mode')">
                                            <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('maitenance_mode') }}</h4>
                        </div>
                                            <div class="card-body">
                             ...
                             <div class="row">
                                <div class="form-group col-md-4">
                                    <b-button type="submit" variant="primary" :disabled="isLoading" v-if="$can('manage_store_settings')">{{ __('update') }}
                                        ...
                                        <div v-if="activeTab === __('one_seller_cart_setting')">
                                            <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('one_seller_cart_setting') }}</h4>
                        </div>
                                         <div class="card-body">
                                            <form method="post" enctype="multipart/form-data" @submit.prevent="saveRecord">
                            <div class=" row -align-items-center"  >
...
export default {
    ...
    data: function () {
        return {
            ...
            Logoerror: null,
            Fssaierror: null,
            tabs: [ __('store_setting'), __('address_setting'), __('other_setting'), __('delivery_boy_setting'), __('maitenance_mode'), __('frontend_home_setting'), __('smtp_mail_setting'), __('google_place_apis'), __('one_seller_cart_setting')],

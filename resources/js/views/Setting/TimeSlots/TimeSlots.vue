              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>{{ __('delivery_starts_from') }}?</label>
                      <select class="form-control form-select" v-model="timeSlot_settingsObject.time_slots_delivery_starts_from">
                        <option value="">{{ __('select_starts_from_day') }}</option>
                        <option value="1">{{ __('today') }}</option>
                        <option value="2">{{ __('tomorrow') }}</option>
                        <option value="3">{{ __('third_day') }}</option>
                        <option value="4">{{ __('fourth_day') }}</option>
                        <option value="5">{{ __('fifth_day') }}</option>
                        <option value="6">{{ __('sixth_day') }}</option>
                        <option value="7">{{ __('seventh_day') }}</option>
                      </select>
                      <br />
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control form-select" v-model="timeSlot_settingsObject.time_slots_allowed_days">
                        <option value="">{{ __('select_allowed_days') }}</option>
                        <option value="1">{{ __('1') }}</option>
                        <option value="7" selected>{{ __('7') }}</option>

...
Route::get('seller/categories', [\App\Http\Controllers\API\CategoryApiController::class, 'getCategories']);
...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::group(['prefix' => 'seller'], function () {
        ...
        Route::get('seller_categories', [\App\Http\Controllers\API\CategoryApiController::class, 'getSellerCategories']);
        Route::get('seller_categoriesapp', [\App\Http\Controllers\API\CategoryApiController::class, 'getSellerCategoriesapp']);
